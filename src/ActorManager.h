...
namespace hdt
{
	...
	private:
		...
		struct Skeleton
		{
			...
			static void doSkeletonMerge(RE::NiNode* dst, RE::NiNode* src, IString* prefix, std::unordered_map<RE::BSFixedString, RE::BSFixedString>& map);
		...
		private:
			...
			bool checkPhysics();
			static void doSkeletonMerge(RE::NiNode* dst, RE::NiNode* src, IString* prefix, std::unordered_map<RE::BSFixedString, RE::BSFixedString>& map, RE::NiNode* dstRoot);
